...
RP_MySQLConfig.Host = XYZShit.DataBase.IP -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
RP_MySQLConfig.Username = XYZShit.DataBase.Username -- This is the username to log in on the MySQL server.
								-- contact the owner of the server about the username and password. Make sure it's in quotation marks! (" ")
RP_MySQLConfig.Password = XYZShit.DataBase.Password -- This is the Password to log in on the MySQL server,
...
RP_MySQLConfig.Database_name = XYZShit.DataBase.Name -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
