...
GM.Config.DisallowDrop = {
    ...
    ["police_checker"] = true,
    ["weapon_drivers_license"] = true,
    ["pass_usa"] = true,
    ["weapon_xyz_keys"] = true,
    ["weapon_cuffed"] = true,
    ...
    ["weapon_cbox"] = true,
    ["weapon_zipties"] = true,
    ["xyz_prison_spoon"] = true,
    ["xyz_prison_wrench"] = true,
    ["weapon_ziptied"] = true,
    ["xyz_mining_axe"] = true,
    ["xyz_mining_drill"] = true,
    ["pass_england"] = true,
    ["cw_m3super90_beanbag"] = true,
    ["xyz_suicide_vest"] = true
}
