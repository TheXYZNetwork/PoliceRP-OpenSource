...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_tundra9mm2"] = { type = "Model", model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "Mp5 Body", rel = "", pos = Vector(0, -15.065, 0.442), angle = Angle(0, 0, -1.17), size = Vector(0.699, 0.885, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
[2] = {header = "Barrel", offset = {-300, -550}, atts = {"md_tundra9mm2"}},
