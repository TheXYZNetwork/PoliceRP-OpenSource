...
print("Loading xWhitelist")

xWhitelist.Info.Version = "1"
xWhitelist.Info.Name = "pol1"
xWhitelist.Info.FullName = "PoliceRP 1"

local path = "xwhitelist/"
if SERVER then
