...
if CLIENT then
    function SWEP:DrawWorldModel()
        ...
        cam.Start3D2D(pos, ang, 0.1)
            draw.SimpleText("Ziptied", "xyz_font_16", 0, 0, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
        cam.End3D2D()
    ...
    function SWEP:DrawHUD()
        ...
        XYZUI.DrawText("You are ziptied", 60, ScrW()/2, 20, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
    end
end