XYZChristmasCredits = {}
XYZChristmasCredits.Config = {}
XYZChristmasCredits.Translate = {}
XYZChristmasCredits.Core = {}
XYZChristmasCredits.UI = {}
XYZChristmasCredits.Database = {}

print("Loading XYZ Christmas Credits")

local path = "xyz_christmas_credits/"
if SERVER then
