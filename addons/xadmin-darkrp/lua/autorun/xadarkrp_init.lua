hook.Add("loadCustomDarkRPItems", "xAdminDarkRP", function() -- TODO: Review if this could be moved to a different hook
	print("Loading xAdmin-DarkRP")
	xADarkRP = {}
	xADarkRP.Config = {}
	xADarkRP.Database = {}
	local path = "xadarkrp/"
