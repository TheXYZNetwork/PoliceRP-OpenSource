XYZChristmasAdvent = {}
XYZChristmasAdvent.Config = {}
XYZChristmasAdvent.Core = {}

XYZChristmasAdvent.OpenedDoors = {}

print("Loading XYZ Christmas Advent")

local path = "xyz_christmas_advent/"
if SERVER then
	...
	XYZChristmasAdvent.CurrentDay = tonumber(os.date("%d", os.time()))
end
