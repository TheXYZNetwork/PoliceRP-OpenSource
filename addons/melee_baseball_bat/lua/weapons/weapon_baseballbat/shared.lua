...
SWEP.VElements = {
	["bat"] = { type = "Model", model = "models/weapons/tfa_nmrih/w_me_bat_metal.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(0, 0, 5), angle = Angle(0, 0, 0), size = Vector(0.819, 0.819, 0.819), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["bat"] = { type = "Model", model = "models/weapons/tfa_nmrih/w_me_bat_metal.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1, -3), angle = Angle(-170, 0, 5), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
