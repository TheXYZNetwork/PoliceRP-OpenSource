...
SWEP.VElements = {
	["megaphone"] = { type = "Model", model = "models/ptejack/props/megaphone/megaphone.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.603, -7.348, -2.314), angle = Angle(0, 0, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["megaphone"] = { type = "Model", model = "models/ptejack/props/megaphone/megaphone.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.553, 1.409, -4.519), angle = Angle(178.791, -180, 2.936), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName = "Police Megaphone"
...
function SWEP:Deploy()
	self.Owner.activeMegaphone = true
end 
